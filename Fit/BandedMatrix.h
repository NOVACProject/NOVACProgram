...
#define _BANDEDMATRIX_ID "$Id: BandedMatrix.h,v 1.12 1999/05/06 19:43:01 granger Exp $"
...
namespace MathFit
{
  ...
  */
  ...
  int LU_factor_banded (MT &A, unsigned int bands)
  {
	  ...
	  // UPD010925 Stefan: Here we have to use double precision or we sometimes get in numerical trouble!
	  double sum;
