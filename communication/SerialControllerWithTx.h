...
namespace Communication
{
    ...
    public:
        ...
        */
        ...
        /** @return the version of the electronics box in the device. */
        ELECTRONICS_BOX GetElectronicsBoxVersion() const { return m_electronicsBoxProperties.version; }
