...
BEGIN_MESSAGE_MAP(CCommunicationController, CWinThread)
    ...
    ON_THREAD_MESSAGE(WM_STATUS_UPLOAD, OnStatusUpload)
END_MESSAGE_MAP()
...
//param wp is a pointer to a CString object telling the spectrometer ID 
//param lp - full path of the file to be uploaded. 
void CCommunicationController::OnStatusUpload(WPARAM wp, LPARAM lp)
{
